...
In get_create_configmap.py file there is a functions for creating ConfigMap:


1. Create ConfigMap

In this we have to pass the namespace in which we will create ConfigMap:
namespace="default"
...
### Running the File:
```
python3 get_create_configmap.py
```
